...
export const routes: Routes = [
  ...
  { path: 'payment-confirmation', loadComponent: () => import('./features/payment/payment-confirmation.component').then(m => m.PaymentConfirmationComponent), canActivate: [AuthGuard] },
  { path: 'payment-success', loadComponent: () => import('./features/payment/payment-success.component').then(m => m.PaymentSuccessComponent), canActivate: [AuthGuard] },
